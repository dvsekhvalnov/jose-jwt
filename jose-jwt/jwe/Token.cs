namespace Jose
{
    ...
    namespace Jwe
    {
        ...
        public class Token
        {
            ...
            public static Token FromString(string token, IJsonMapper jsonMapper = null)
            {
            ...
            private static Token ParseCompact(string jwe)
            {
            ...
            private static Token ParseJson(IDictionary<string, object> json)
            {
                var recipients = new List<(byte[] EncryptedCek, IDictionary<string, object> Header)>();
