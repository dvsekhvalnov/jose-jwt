...
namespace UnitTests
{
    public class TestSuite
    {
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Decrypt_ECDH_ES_A192GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Decrypt_ECDH_ES_A256GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Decrypt_ECDH_ES_A192KW_A192GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Decrypt_ECDH_ES_A256KW_A256GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Encrypt_ECDH_ES_A192GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
            ...
            //when
            string token = Jose.JWT.Encode(json, testSuiteUtils.Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A192GCM);
        ...
        [InlineData("CNG")]
        [InlineData("ECDH")]
        public void Encrypt_ECDH_ES_A256GCM(string keyImplementation)
        {
            if (keyImplementation == "CNG")
            {
                Skip.IfNot(RuntimeInformation.IsOSPlatform(OSPlatform.Windows), "This requires CNG, which is Windows Only.");
            ...
            //when
            string token = Jose.JWT.Encode(json, testSuiteUtils.Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A256GCM);
        ...
        public void Headers()
        {
            ...
            Assert.Equal(8192L, test["p2c"]);
            Assert.Equal("NkXji1947fRsKTlB", test["p2s"]);
            Assert.Equal(1363284000L, test["exp"]);
        ...
        public void EncodeWithUnencodedDetachedExtraHeaders()
        {
            ...
            Assert.Equal(1363284000L, Convert.ToInt64(tokenHeaders["exp"]));
        }
