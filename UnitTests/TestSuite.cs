...
namespace UnitTests
{
    public class TestSuite
    {
        ...
        public void Encrypt_RSA_OAEP_384_A192GCM()
        {
            ...
            //when
            string token = Jose.JWT.Encode(json, testSuiteUtils.PubKey(), JweAlgorithm.RSA_OAEP_384, JweEncryption.A192GCM);
        ...
        public void VerifyUnknownAlg()
        {
            ...
            //then            
            Assert.Throws<InvalidAlgorithmException>(() => Jose.JWT.Verify(token, testSuiteUtils.PubKey()));
        }
        ...
        public void VerifyEncryptedToken()
        {
            ...
            //then
            Assert.Throws<JoseException>(() => Jose.JWT.Verify(token, testSuiteUtils.PubKey()));
        }
        ...
        public void VerifyTokenWrongAlg()
        {
            ...
            //then
            Assert.Throws<InvalidAlgorithmException>(() => Jose.JWT.Decode(token, testSuiteUtils.PubKey(), JwsAlgorithm.RS256));
        }
        ...
        public void DecryptBytes()
        {
            ...
            //when
            var payload = Jose.JWT.DecryptBytes(token, testSuiteUtils.PrivKey());
